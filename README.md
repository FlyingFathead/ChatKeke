...
ChatKeke utilizes Python+Flask (+gunicorn as a deployment option)
Backend can be connected to i.e. any Nginx-type [micro]server web server+front end setup with ease
